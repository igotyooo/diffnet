...
function task:aggregateAnswers( answers, queryNumber )
    local dstDir = paths.concat( self.opt.dirRoot, 'pftest/vgg16_d' )
    paths.mkdir( dstDir )
