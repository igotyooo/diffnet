...
local ucf1_vgg16_di = '/home/dgyoo/workspace/dataout/diffnet/UCF101_RGB_S1/vi_vgg16pt_d_slcls,batchSize=256,diffLevel=0,epochSize=299,stride=4/model_026,batchSize=256,diffLevel=0,epochSize=299,learnRate=1e-4,1e-4,stride=4/model_028,batchSize=256,diffLevel=0,epochSize=299,stride=4/test_nc25_1.t7'
...
local ucf1_vggm_di = '/home/dgyoo/workspace/dataout/diffnet/UCF101_RGB_S1/vi_vggmpt_d_slcls,batchSize=384,diffLevel=0,epochSize=199,stride=4/model_028,batchSize=384,diffLevel=0,epochSize=199,learnRate=1e-4,1e-4,stride=4/model_025,batchSize=384,diffLevel=0,epochSize=199,stride=4/test_nc25_1.t7'
...
local sid2path = { ucf1_vggm_di, ucf1_vggm_sp }
local resolution = 20
